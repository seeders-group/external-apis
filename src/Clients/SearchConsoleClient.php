...
final class SearchConsoleClient
{
    ...
    public function setAccessToken(string $accessToken, string $refreshToken): void
    {
        $this->client->setAccessToken($accessToken);
        $this->client->refreshToken($refreshToken);
        $logger = new Logger('test');
        $tokenCallback = function (string $cacheKey, string $accessToken) use ($logger): void {
    ...
    private function getUniqueItemHash(mixed $row, mixed $request): string
    {
